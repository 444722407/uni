...
.help .uni-collapse-item__title-box {
...
.help .uni-collapse-item__wrap-content {
  font-size: 28rpx;
  color: #fff;
  padding:0 0 40rpx;
  background-color: #262626;
...
.help .uni-collapse-item__title-arrow {
  margin-right: 0;
  transform: rotate(-90deg);
}

.help .uni-collapse-item__title-arrow-active {
  transform: rotate(0deg);
}
.help .active .uni-collapse-item__title-box{
  color: #FFD717;
}
.help .active .uni-collapse-item__title-box,
.help .active .uni-collapse-item,.help .active .uni-collapse-item__wrap-content{
